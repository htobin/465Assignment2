...
//this entire page was created by Jan Stelovsky, only needed to use the shuffle function
...
(function() {
    /*
      ...
      Obviously, there should be possible to generate the groups in a sheet directly using Google App Script, or even
